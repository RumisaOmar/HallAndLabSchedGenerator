...
namespace HallsAndLabsScheduleGenerator.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mick = table.Column<string>(nullable: true),
                    Projector = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleDatas_Schedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "Schedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduleDatas_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduleDatas_Teachers_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleDatas_ScheduleId",
                table: "ScheduleDatas",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduleDatas_SubjectId",
                table: "ScheduleDatas",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduleDatas_TeacherId",
                table: "ScheduleDatas",
                column: "TeacherId");
