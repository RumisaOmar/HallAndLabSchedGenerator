...
namespace HallsAndLabsScheduleGenerator.Controllers
{
    public class SubjectController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Semester")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Semester")] Subject subject)
        {
            if (id != subject.Id)
            {
                return NotFound();
